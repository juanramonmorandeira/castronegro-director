...
las queues, dentro de `session.history`.

`role_state_revealed` = queueStage informativa generada cuando un role queda
...
queue, objectiveRules e historiales reales sobre los que se resuelven
stages y recipes.
