...
| `link_targets` | Cupido | implementada | Crea un group con miembros, `groupRules`, `selectionRules` y `objectiveRules`. |
...
| `linked_objective` | Enamorados de bandos distintos | implementada | El group aporta objectiveRule y `objectiveModel` la recopila si aplica. |
