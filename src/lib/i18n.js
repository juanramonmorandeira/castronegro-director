...
const dictionaries = {
  en: {
    ...
    configure: {
      ...
      match_offline_players_label: 'Add offline players',
      match_offline_players_hint: 'Create placeholders for players who are not connected.',
  ...
  es: {
    ...
    configure: {
      ...
      match_offline_players_label: 'Añadir jugadores sin conexión',
      match_offline_players_hint: 'Crea marcadores para jugadores que no están conectados.',
      match_players_title: 'Jugadores',
  ...
  hu: {
    ...
    configure: {
      ...
      properties_title: 'Tulajdonságok',
      ...
      match_offline_players_label: 'Offline játékosok hozzáadása',
      match_offline_players_hint: 'Helyettesítőket adhatsz a nem csatlakozott játékosokhoz.',
      match_players_title: 'Játékosok',
